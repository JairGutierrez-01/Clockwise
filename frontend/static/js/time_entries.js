 ...
 * @async
 * @function createEntryAPI
 * @param {Object} data - Data for the new time entry
 * @returns {Promise<Object>} Resolves to the created entry object
 * @throws {Error} If the fetch request fails
 */
async function createEntryAPI(data) {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (
    ...
    /**
     * Recalculates and displays the duration for a manual time entry.
     * Reads the date, start, and end inputs, computes the difference in seconds,
     * and updates the manualDuration element with the formatted duration.
